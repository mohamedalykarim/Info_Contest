...
public class ActivityResultBindingImpl extends ActivityResultBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textView10, 2);
        sViewsWithIds.put(R.id.progressBar2, 3);
        sViewsWithIds.put(R.id.progressBar4, 4);
        sViewsWithIds.put(R.id.progressBar, 5);
        sViewsWithIds.put(R.id.correctTv, 6);
        sViewsWithIds.put(R.id.wrongTv, 7);
        sViewsWithIds.put(R.id.textView15, 8);
        sViewsWithIds.put(R.id.textView12, 9);
        sViewsWithIds.put(R.id.view, 10);
        sViewsWithIds.put(R.id.resultTV, 11);
    }
    // views
    @NonNull
