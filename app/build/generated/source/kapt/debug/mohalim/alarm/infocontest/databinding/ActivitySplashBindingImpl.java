...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.loadingTV, 5);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((mohalim.alarm.infocontest.ui.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable mohalim.alarm.infocontest.ui.splash.SplashViewModel ViewModel) {
